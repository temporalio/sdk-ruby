...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("temporal/sdk/core/activity_task/activity_task.proto", :syntax => :proto3) do
    ...
    add_message "coresdk.activity_task.Start" do
      ...
      optional :workflow_execution, :message, 3, "coresdk.common.WorkflowExecution"
      optional :activity_id, :string, 4
      optional :activity_type, :string, 5
      map :header_fields, :string, :message, 6, "coresdk.common.Payload"
      repeated :input, :message, 7, "coresdk.common.Payload"
      repeated :heartbeat_details, :message, 8, "coresdk.common.Payload"
      ...
      optional :retry_policy, :message, 16, "coresdk.common.RetryPolicy"
