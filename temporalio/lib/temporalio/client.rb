...
module Temporalio
  ...
  class Client
    ...
    # @param dns_load_balancing [Connection::DnsLoadBalancingOptions, nil] DNS load balancing options for the connection.
    #   Default is +nil+ (disabled). Silently disabled when +http_connect_proxy+ is set, since the two are mutually
    #   exclusive.
    #
