...
require 'temporalio/api/enums/v1/nexus'
  ...
  module Api
    module Failure
      module V1
        ...
        NexusOperationFailureInfo = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("temporal.api.failure.v1.NexusOperationFailureInfo").msgclass
        NexusHandlerFailureInfo = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("temporal.api.failure.v1.NexusHandlerFailureInfo").msgclass
        Failure = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("temporal.api.failure.v1.Failure").msgclass
        MultiOperationExecutionAborted = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("temporal.api.failure.v1.MultiOperationExecutionAborted").msgclass
      end
    end
  end
end
