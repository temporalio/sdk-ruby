...
require 'temporalio/api/activity/v1/message'
  ...
  module Api
    module Batch
      module V1
        ...
        BatchOperationTerminateActivities = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("temporal.api.batch.v1.BatchOperationTerminateActivities").msgclass
        ...
        BatchOperationCancelActivities = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("temporal.api.batch.v1.BatchOperationCancelActivities").msgclass
        ...
        BatchOperationDeleteActivities = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("temporal.api.batch.v1.BatchOperationDeleteActivities").msgclass
