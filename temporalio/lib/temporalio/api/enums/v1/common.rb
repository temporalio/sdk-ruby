  ...
  module Api
    module Enums
      module V1
        ...
        WorkflowRuleActionScope = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("temporal.api.enums.v1.WorkflowRuleActionScope").enummodule
        ApplicationErrorCategory = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("temporal.api.enums.v1.ApplicationErrorCategory").enummodule
        WorkerStatus = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("temporal.api.enums.v1.WorkerStatus").enummodule
        ExecutionType = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("temporal.api.enums.v1.ExecutionType").enummodule
      end
    end
  end
end
