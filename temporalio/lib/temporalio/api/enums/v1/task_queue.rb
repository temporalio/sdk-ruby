  ...
  module Api
    module Enums
      module V1
        ...
        RateLimitSource = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("temporal.api.enums.v1.RateLimitSource").enummodule
        RoutingConfigUpdateState = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("temporal.api.enums.v1.RoutingConfigUpdateState").enummodule
      end
    end
  end
end
