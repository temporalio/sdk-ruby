  ...
  module Api
    module Enums
      module V1
        ...
        VersioningBehavior = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("temporal.api.enums.v1.VersioningBehavior").enummodule
        ContinueAsNewVersioningBehavior = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("temporal.api.enums.v1.ContinueAsNewVersioningBehavior").enummodule
        SuggestContinueAsNewReason = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("temporal.api.enums.v1.SuggestContinueAsNewReason").enummodule
      end
    end
  end
end
