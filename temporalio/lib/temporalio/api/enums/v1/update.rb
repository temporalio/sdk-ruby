  ...
  module Api
    module Enums
      module V1
        ...
        UpdateRequestedEventOrigin = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("temporal.api.enums.v1.UpdateRequestedEventOrigin").enummodule
      end
    end
  end
end
