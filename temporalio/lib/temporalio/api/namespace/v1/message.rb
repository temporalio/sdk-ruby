  ...
  module Api
    module Namespace
      module V1
        ...
        NamespaceInfo::Capabilities = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("temporal.api.namespace.v1.NamespaceInfo.Capabilities").msgclass
        NamespaceInfo::Limits = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("temporal.api.namespace.v1.NamespaceInfo.Limits").msgclass
