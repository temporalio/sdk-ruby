...
module Temporalio
  module Api
    module Cloud
      module Nexus
        module V1
          EndpointSpec = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("temporal.api.cloud.nexus.v1.EndpointSpec").msgclass
          EndpointTargetSpec = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("temporal.api.cloud.nexus.v1.EndpointTargetSpec").msgclass
          WorkerTargetSpec = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("temporal.api.cloud.nexus.v1.WorkerTargetSpec").msgclass
          EndpointPolicySpec = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("temporal.api.cloud.nexus.v1.EndpointPolicySpec").msgclass
          AllowedCloudNamespacePolicySpec = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("temporal.api.cloud.nexus.v1.AllowedCloudNamespacePolicySpec").msgclass
          Endpoint = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("temporal.api.cloud.nexus.v1.Endpoint").msgclass
        end
      end
    end
  end
