    ...
    module Cloud
      module Identity
        module V1
          ...
          AccountAccess::Role = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("temporal.api.cloud.identity.v1.AccountAccess.Role").enummodule
          ...
          NamespaceAccess::Permission = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("temporal.api.cloud.identity.v1.NamespaceAccess.Permission").enummodule
          ...
          GoogleGroupSpec = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("temporal.api.cloud.identity.v1.GoogleGroupSpec").msgclass
