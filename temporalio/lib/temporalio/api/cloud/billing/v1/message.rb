    ...
    module Cloud
      module Billing
        module V1
          ...
          BillingReportSpec::BillingReportGranularity = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("temporal.api.cloud.billing.v1.BillingReportSpec.BillingReportGranularity").enummodule
