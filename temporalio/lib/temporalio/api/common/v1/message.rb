  ...
  module Api
    module Common
      module V1
        ...
        Payload::ExternalPayloadDetails = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("temporal.api.common.v1.Payload.ExternalPayloadDetails").msgclass
        ...
        Execution = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("temporal.api.common.v1.Execution").msgclass
        ...
        Link::WorkflowEvent::RequestIdReference = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("temporal.api.common.v1.Link.WorkflowEvent.RequestIdReference").msgclass
