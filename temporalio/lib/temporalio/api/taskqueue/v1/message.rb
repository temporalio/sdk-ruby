  ...
  module Api
    module TaskQueue
      module V1
        ...
        PollerGroupsInfo = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("temporal.api.taskqueue.v1.PollerGroupsInfo").msgclass
        ...
        RateLimitConfig = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("temporal.api.taskqueue.v1.RateLimitConfig").msgclass
        TaskQueueConfig = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("temporal.api.taskqueue.v1.TaskQueueConfig").msgclass
      end
    end
  end
end
