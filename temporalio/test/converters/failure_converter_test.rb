...
module Converters
  class FailureConverterTest < Test
    def test_failure_with_causes
      ...
      orig_err = assert_raises do
        begin
          begin
            ...
            raise Temporalio::Error::Failure::ApplicationError, 'Application error no details'
          end
        rescue StandardError
          raise Temporalio::Error::Failure::ApplicationError.new('Application error with details', { foo: 'bar' })
        end
      rescue StandardError
        raise Temporalio::Error::Failure::ChildWorkflowError.new(
          'Child error',
          namespace: 'ns',
          workflow_id: 'wfid',
          run_id: 'runid',
          ...
          retry_state: Temporalio::Error::Failure::RetryState::RETRY_POLICY_NOT_SET
        )
      end

      # Confirm multiple nested
      assert_instance_of Temporalio::Error::Failure::ChildWorkflowError, orig_err
      refute_empty orig_err.backtrace
      assert_equal 'Child error', orig_err.message
      assert_equal Temporalio::Error::Failure::RetryState::RETRY_POLICY_NOT_SET, orig_err.retry_state
      assert_instance_of Temporalio::Error::Failure::ApplicationError, orig_err.cause
      ...
      assert_instance_of Temporalio::Error::Failure::ApplicationError, orig_err.cause.cause
      ...
      assert_equal Temporalio::Error::Failure::RetryState::RETRY_POLICY_NOT_SET,
      ...
      assert_instance_of Temporalio::Error::Failure::ChildWorkflowError, new_err
      assert_equal orig_err.backtrace, new_err.backtrace
      assert_equal 'Child error', new_err.message
      assert_equal Temporalio::Error::Failure::RetryState::RETRY_POLICY_NOT_SET, new_err.retry_state
      assert_instance_of Temporalio::Error::Failure::ApplicationError, new_err.cause
      ...
      assert_instance_of Temporalio::Error::Failure::ApplicationError, new_err.cause.cause
      ...
      assert_instance_of Temporalio::Error::Failure::ApplicationError, new_err.cause.cause.cause
